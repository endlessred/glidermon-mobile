...
import * as spine from "@esotericsoftware/spine-core"; // ← added
...
export class SkeletonMesh extends THREE.Object3D {
  ...
  // ✅ Pass the Physics object; if missing, it's undefined, which the runtime tolerates.
  const physicsMaybe: any = (spine as any)?.Physics;
  this.skeleton.updateWorldTransform(physicsMaybe);
