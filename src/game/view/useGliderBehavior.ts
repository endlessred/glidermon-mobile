...
import { useGameStore } from "../../data/stores/gameStore"; // for mgdl
...
import { BehaviorLoader, BUILTIN_BEHAVIORS } from "../behaviors/behaviorLoader";
...
try {
  ...
  useSettingsStore = require("../../data/stores/settingsStore").useSettingsStore;
} catch {
